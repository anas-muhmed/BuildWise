// lib/reducer.ts
// 🎯 This file contains our STATE MANAGEMENT logic using useReducer

// 🎯 LEARNING: Import types from our components
...
export function appReducer(state: AppState, action: AppAction): AppState {
  switch (action.type) {
    ...
    // 🔄 User switches tab (Overview/Best/Cost)
    case "SET_ACTIVE_TAB":
      return {
        ...state,
        ui: {
    ...
    // ✅ AI finishes generating architecture
    ...
    // 💭 Add AI thinking step (e.g., "Analyzing patterns...")
    ...
    // 📄 Add explanation text one by one (typing effect)
    ...
    // 🔄 Reset displayed text (used before generating new)
    ...
    // ⚠️ Unknown action - return state unchanged
    default:
      return state;
  }
}
